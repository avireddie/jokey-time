...
const PAGES = [
  { type: 'cover' },
  { type: 'image', src: 'images/preface.png', alt: 'Preface page' },

  { type: 'image', src: 'images/1.png', alt: 'Joke 1: Why do birds fly south for the winter? Because it\'s too far to walk.' },
  { type: 'image', src: 'images/2.png', alt: 'Joke 2: Where do people go with two broken legs? Nowhere.' },
  { type: 'image', src: 'images/3.png', alt: 'Joke 3: Why was the cell phone scared to go to the dentist? Because it didn\'t want its blue tooth removed.' },
  { type: 'image', src: 'images/4.png', alt: 'Joke 4: Why did the golfer bring two pairs of pants? In case he got a hole in one.' },
  { type: 'image', src: 'images/5.png', alt: 'Joke 5: Why did the teacher wear sunglasses? Because the students were too bright.' },
  { type: 'image', src: 'images/6.png', alt: 'Joke 6: Why don\'t skeletons fight each other? They don\'t have the guts.' },
  { type: 'image', src: 'images/7.png', alt: 'Joke 7: Why did the computer go to the doctor? Because it caught a virus.' },
  { type: 'image', src: 'images/8.png', alt: 'Joke 8: Why don\'t calendars ever get lonely? Because they have so many dates.' },
  { type: 'image', src: 'images/9.png', alt: 'Joke 9: Why did the stadium get so hot? Because all the fans left.' },
